...
let UserCookie = ($.isNode() ? process.env.ttdk : $.getdata('ttdk')) || '';
let UserCookieArr = [];
let data = '';
let msg =``;
let isSign = false;
...
function getVersion(timeout = 3 * 1000) {
    return new Promise((resolve) => {
        let url = {
            url: `https://ghproxy.com/https://raw.githubusercontent.com/YourAhTzu/YourAhTzu/main/ttdk.js`,
        }
